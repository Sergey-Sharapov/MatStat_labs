...
\begin{document}
	...
	\section{Реализация}
	Для генерации случайных чисел с различными распределениями был использован модуль $random$ библиотеки $numpy$ языка $Python\;3.7$ . Боксплот Тьюки был построен средствами $matplotlib$.
	\newpage
	\section{Результаты}
	...
	\href{https://github.com/Sergey-Sharapov/MatStat_labs/blob/main/lab3/lab3.py}{Код лаборатрной}
